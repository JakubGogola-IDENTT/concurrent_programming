...
func Init() {
	...
	// Create channels for machines
	channels := machineChannels{}
	channels.addingMachineChannels, channels.addingMachinesRepairChannels = createAddingMachines()
	channels.multiplyingMachineChannels, channels.multiplyingMachinesRepairChannels = createMultiplyingMachines()
